...
module.exports = {
    ...
    async create (req, res) {
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/airports/create', datos);
    ...
    async update(req, res) {
        try {
            ...
            const options = {
                method: 'PUT',
                url: `http://localhost:8080/api/airports/update`, 
                headers: {
                    'Content-Type': 'application/json'
                },
                data: nuevosDatos
    ...
    async delete (req, res) {
        try {
            ...
            const options = {
                method: 'DELETE',
                url: `http://localhost:8080/api/airports/delete/${id}`, // Utiliza la ruta de la API 1 para eliminar un cliente
                headers: {
                    'Content-Type': 'application/json'
                }
            };
